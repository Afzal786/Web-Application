...
<table width="754" border="0" align="center" cellpadding="0" cellspacing="2">
  ...
  <tr class="white">
    <td align="left" valign="top" class="white"><table width="99%" border="0" align="center" cellpadding="5" cellspacing="0" rowspan="2" colspan="3">
      <tr>
		...
		<div style="background-color:yellow;">
			...
			if(mysqli_num_rows($dbresult) >0)
                ...
                echo "Image : " ; ?> 
				<img src="images/<?php echo $row[0].".jpg" ?>" alt="My pic" height="42" width="42"/>
				<?php
				}	
			}	
