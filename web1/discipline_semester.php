...
<table width="754" border="0" align="center" cellpadding="0" cellspacing="2">
  ...
  <tr class="white">
    <td align="left" valign="top" class="text_black_huge">
...
{
	echo " <br/> ";
echo "<table width='90%' border='3' style='background-color:silver' align='center' cellpadding='2' cellspacing='2' class='text_black'>";
echo "              <tr align=\"center\" valign=\"top\" bgcolor=\"yellow\" class='yellow'>";
echo "                 <td bgcolor='yellow' class=\"yellow\">Enrollment no</td>";
echo "                 <td>Name</td>";
