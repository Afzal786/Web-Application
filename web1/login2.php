    ...
    <td align="left" valign="top" class="white"><table width="99%" border="0" align="center" cellpadding="5" cellspacing="0">
      <tr>
        ...
        <td width="96%" align="left" valign="top"><table width="95%" border="0" cellpadding="2" cellspacing="2" class="text_black">
          ...
          <tr>
            <td><form id="form1" name="form1" method="post" action="validation2.php">
			 ...
			 <p style="margin-top:20px">
              ...
              <label> Password </label><label style="margin-left:7px">
                <input name="password" type="password" class="menu" id="password" size="25" maxlength="255"  />
               </label>
             </p>
              <p>
                <label>
                <input name="Submit" type="submit" class="menu" value="Login" style="margin:10px"/>
                </label>
                <label>
                <input name="Submit2" type="reset" class="menu" value="Reset" style="margin:10px" />
                </label>
              </p>
            </form>
            </td>
