    ...
    <td align="left" valign="top" class="white"><table width="99%" border="0" align="center" cellpadding="5" cellspacing="0">
      <tr>
        ...
        <td width="96%" align="left" valign="top"><table width="95%" border="0" cellpadding="2" cellspacing="2" class="text_black">
          ...
          <tr>
            <td><form id="form1" name="form1" method="post" action="editadmin1.php" class="pure-form">
            <ul>
											<li class="text">Email :  </li>
											<li class="agileits-main"><input name="username" type="text" required></li>
										</ul>
										<ul>
										...
										<ul>
											...
											<li class="agileits-main"><input name="confirm password" id="confirm password" type="password" required></li>
										</ul>	
